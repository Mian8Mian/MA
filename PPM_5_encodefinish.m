...
columnsize=20;    %comment if data is the whole matrix
blocknumber=225;      %set 1 if data is the whole matrix
order=2;
format long;
...
%%%%%%%%%%%%%%%%%%%%            PPM               %%%%%%%%%%%%%%%%%%%%%%%%%
%block=[123,123,123,104,123,123,104,114,125,130,132,114,125,130,104,125];
%initialising table
n=order;
for o=1:n+1
    k(o)=1;
